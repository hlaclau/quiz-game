...
export const Particles: React.FC<ParticlesProps> = ({
	...
	const animate = () => {
		...
		// Filter out circles that are out of bounds, and collect new ones
		circles.current = circles.current.filter((circle: Circle) => {
			...
			if (isOutOfBounds) {
				// Queue a new circle to replace this one
				newCircles.push(circleParams());
